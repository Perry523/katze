<template>
  <div :style="{'width':'430px'}">
      ...
      <div :style="{'white-space':'nowrap','height':'80px','overflow-x':'auto','overflow-y':'hidden'}">
      <div :style=" {'display':'inline-flex',}" v-for="(imagem, i) in produto.imagens" :key="i">
          <div :style=" {'height':'80px','width':'80px','margin': '0px 10px','box-sizing':'border-box'}">
            ...
            <img :src="produto.imagens[i].src" :id="'id'+i" height="80px" width="80px" alt="" @click="changeUrl">
          </div>
      </div>
      </div>
